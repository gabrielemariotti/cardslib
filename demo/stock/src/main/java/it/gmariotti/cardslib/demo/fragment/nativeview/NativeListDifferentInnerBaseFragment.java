...
public class NativeListDifferentInnerBaseFragment extends BaseMaterialFragment {
    ...
    /**
     *  With multiple inner layouts you have to set the viewTypeCount with {@link it.gmariotti.cardslib.library.internal.CardArrayAdapter#setInnerViewTypeCount(int)}.
     *  </p>
     *  An alternative is to provide your CardArrayAdapter  where you have to override this method:
     *  </p>
     *  public int getViewTypeCount() {}
     *  </p>
     *  You have to provide in your card the type value with {@link it.gmariotti.cardslib.library.internal.Card#setType(int)} method.
     *
     */
