...
import it.gmariotti.cardslib.library.internal.CursorSwipeCardAdapter;
 ...
 */
public class ListCursorCardSwipeFragment extends BaseFragment implements LoaderManager.LoaderCallbacks<Cursor> {

    MyCursorCardSwipeAdapter mAdapter;
    ...
    private void init() {
        ...
        mAdapter = new MyCursorCardSwipeAdapter(getActivity());
    ...
    public class MyCursorCardSwipeAdapter extends CursorSwipeCardAdapter {

        public MyCursorCardSwipeAdapter(Context context) {
            super(context);
        }

        @Override
        protected void doOperationOnDBAfterSwipe(Card card) {
            //Use this code to delete items on DB
            ContentResolver resolver = getActivity().getContentResolver();
            long dDeleted = resolver.delete
