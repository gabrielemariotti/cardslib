 ...
 */
public class NativeStaggeredGridFragment extends BaseNativeListFragment {

    ServerDatabase mServerDatabase;
    CardGridStaggeredArrayAdapter mCardArrayAdapter;

    public NativeStaggeredGridFragment() {
        super();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.demo_extras_native_fragment_staggeredgrid, container, false);
