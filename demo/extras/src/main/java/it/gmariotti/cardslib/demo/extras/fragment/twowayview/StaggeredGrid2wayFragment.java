 ...
 */
public class StaggeredGrid2wayFragment extends BaseListFragment {

    ServerDatabase mServerDatabase;
    CardArrayRecyclerViewAdapter mCardArrayAdapter;

    public StaggeredGrid2wayFragment() {
        super();
    }

    @Override
    public int getTitleResourceId() {
        return R.string.carddemo_extras_title_staggered2viewway;
    }


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.demo_extras_fragment_staggeredgrid_twowayview, container, false);
        ...
        private void init() {
            ...
            setOnClickListener(new OnCardClickListener() {
                ...
                public void onClick(Card card, View view) {
                    Toast.makeText(getContext(),"Click on "+image.title.toUpperCase(),Toast.LENGTH_SHORT).show();
                }
            });
        }
